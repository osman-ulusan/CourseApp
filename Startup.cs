...
namespace CourseApp
{
    ...
    {
        //Dependency Injection , database a bağlanma yöntemimiz. 
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, DataContext dataContext)
        {
            ...
            //Hata ya da durum sayfalarını göstermesi için kullandığımız kod.
            app.UseStatusCodePages();

            //Varsayılan olarak wwwroot dosyasını göstererek bu dosyanın içindeki css,js,lib dosyalarına ulaşmak için kullanıyoruz.
            app.UseStaticFiles();
